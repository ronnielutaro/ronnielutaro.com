...
This project uses MDX (Markdown + JSX) for content management, allowing you to easily add and manage project case studies without touching any code. Blog functionality has been removed; all content should be added as blog.
...
1. Create a new `.mdx` file in the `content/blog/` folder
...
- **Auto-listing**: New MDX files automatically appear on the blog page
- **SEO-friendly URLs**: Filenames become URL slugs (e.g., `my-project.mdx` → `/blog/my-project`)
...
1. Add your `.mdx` file to the `content/blog/` folder
